      ...
      {allCvData?.data?.map((resume, index) => (
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-white font-medium">{resume.first_name} {resume.last_name} ({index})</h2>
              <p className="text-sm text-gray-400">Created: {resume.dob}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="flex items-center gap-1 px-3 py-1 rounded-lg bg-red-900/30 text-red-500 border border-red-700 hover:bg-red-900/50 transition">
              <FiTrash2 /> Delete
            </button>
          </div>
        </div>
