  ...
  return (
    <div className="section-padding-x section-padding-y space-y-6">
      ...
      <div className="mt-8 space-y-4">
        ...
        <Title level="title16">Address: Example Street 12, 12345 Berlin, Germany</Title>
      ...
      <div className="mt-8 space-y-4">
        ...
        <Title level="title16">If you have any questions or concerns, please contact us at:</Title>
        <Title level="title16">Email: contact@clever-cv.com</Title>
        <Title level="title16">Phone: +49 30 12345678</Title>
      </div>
    </div>
