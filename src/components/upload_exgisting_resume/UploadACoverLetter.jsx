...
const UploadACoverLetter = () => {
  return (
    <div>
          <div className="max-w-5xl mx-auto w-full">
        <div className="text-center flex flex-col items-center gap-4 mb-10">
          <Title level="title32"> Upload a Cover Letter</Title>
          <Title level="title16">
           Already have a cover letter? Upload it here to combine it with your resume. Or, let our AI generate one for you later.
...
export default UploadACoverLetter
