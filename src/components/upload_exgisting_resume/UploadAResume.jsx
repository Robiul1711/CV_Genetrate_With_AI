...
//               <Controller
//               disabled={!status?.multilingual_support}
//                 control={control}
...
const UploadAResume = () => {
  ...
  const t = {
    en: {
      ...
      complexity: "Complexity Level",
      creativity: "Creativity Level",
      multiDisabled: "Multilingual support is not enabled for your plan.",
      upgrade: "Go to Pricing to enable",
    },
    de: {
      pageTitle: "Laden Sie Ihren Lebenslauf hoch",
      pageSubtitle:
      ...
      complexity: "Komplexitätsgrad",
      creativity: "Kreativitätsgrad",
      multiDisabled: "Mehrsprachige Unterstützung ist für Ihren Plan nicht aktiviert.",
      upgrade: "Zur Preisübersicht",
    },
  }[language || "en"];
        ...
        <div className="bg-[#121212] rounded-xl p-6 border border-[#262626]">
          ...
          <form onSubmit={handleSubmit(onSubmitFile)} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <select
                    ...
                    disabled={!status?.multilingual_support}
                    className={`bg-[#1a1a1a] px-4 py-3 text-sm rounded-lg border border-[#333] text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${
                      !status?.multilingual_support ? "opacity-50 cursor-not-allowed" : ""
                    }`}
                  >
              ...
              />
              {!status?.multilingual_support && (
                <p className="text-red-500 text-xs mt-2">
                  {t.multiDisabled}{" "}
                  <button
                    type="button"
                    onClick={() => navigate("/price")}
                    className="underline text-blue-400 hover:text-blue-500 ml-1"
                  >
                    {t.upgrade}
                  </button>
                </p>
              ...
              {errors.converted_language && (
                <p className="text-red-500 text-xs mt-1">{errors.converted_language.message}</p>
              )}
            </div>
