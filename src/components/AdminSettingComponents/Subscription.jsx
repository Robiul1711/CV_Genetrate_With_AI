...
<button className="px-2 sm:px-4 py-2 border bg-black text-white rounded-full text-xs   ">Current Plan</button>
</div>
<div className="w-full sm:flex justify-end items-start">
<button className="font-semibold border border-white  px-2  py-2 text-sm  rounded-md bg-white text-black transition-colors duration-300 ">Upgrade Plan</button>
</div>
</div>
