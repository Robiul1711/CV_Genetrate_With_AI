  ...
  return (
    <div>
      <Dialog>
        <DialogTrigger>
          {" "}
          <button className="font-semibold flex items-center max-w-sm gap-2 border-white/20 bg-white text-black    px-2  py-2 text-sm  rounded-md hover:bg-[#69CA6A] hover:text-white transition-colors duration-300">
        Save New Password
          </button>
        </DialogTrigger>
