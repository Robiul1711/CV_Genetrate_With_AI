  ...
  return (
    <div className="my-8">
      ...
      <div className="grid md:grid-cols-2 gap-12 pb-20 section-padding-x">
        {/* Left Side Title */}
        <div className="flex items-center border-r border-[#262626]">
      ...
      <div className="grid md:grid-cols-2 gap-12 pt-16 section-padding-x items-start">
        {/* Asked Question Left Block */}
        <div className="flex flex-col items-start justify-center border-r border-[#262626]">
          <div className="flex flex-col items-start gap-3 mb-4">
            <div className="bg-[#0E0E10] p-2 rounded-full">
