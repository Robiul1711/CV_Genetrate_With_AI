  ...
  return (
    <div className="relative pb-28 h-[600px] overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 w-full max-w-5xl px-4 -translate-x-1/2 -translate-y-1/2 text-center flex flex-col items-center z-10">
        <h1 className="text-[28px] md:text-[48px] font-bold leading-snug text-white">
        ...
        <div className="flex items-center gap-5">
          <button className="mt-10 px-6 md:px-8 py-3 md:py-4 rounded-xl border border-[#81FB84]/20 text-white hover:bg-white hover:text-dark transition-all duration-300 font-medium">
            Create Your Resume
          </button>
        </div>
      </div>
