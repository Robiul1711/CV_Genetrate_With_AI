...
const ReadyToLand = () => {
  return (
    <div className="relative pb-28 h-[300px]  overflow-hidden">
      {/* Background Image */}
      <img
        src={starBG}
      ...
      <div className="absolute top-1/2 left-1/2 w-full max-w-5xl px-4 -translate-x-1/2 -translate-y-1/2 text-center flex flex-col items-center z-10">
        ...
        <p className=" text-[#9B9B9B] pt-4 max-w-2xl">
          Let Clever-CV guide you with expert AI tools — build, improve, and
          export your resume in minutes.
        </p>
        <div className="flex items-center gap-5">
          <Link to="/dashboard/create-new-resume" className="mt-10 px-6  py-3  rounded-xl text-sm md:text-base border border-[#81FB84]/20 text-white hover:bg-white hover:text-dark transition-all duration-300 font-medium">
            Create Your Resume
          </Link>
        </div>
      </div>
