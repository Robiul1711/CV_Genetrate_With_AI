  ...
  return (
    <div className="pb-8 md:pb-16 lg:pb-20 xl:pb-28">
      ...
      <div className="mt-8 md:mt-12 lg:mt-16 xl:mt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        <div className=" hover:border border border-white/20 rounded-xl shadow-lg xlg:p-6 p-5 md:p-3 text-white  hover:border-white duration-300 transition-all transform">
        ...
        <div className=" hover:border border border-white/20 rounded-xl shadow-lg xlg:p-6 p-3 text-white  hover:border-white duration-300 transition-all transform">
          <button className="border mb-6 flex items-center gap-2  font-semibold py-2 px-5  rounded-md">
           Basic Plan
            <UpgradeIcon />
          </button>
        ...
        <div className="relative hover:border border border-white/20 rounded-xl shadow-lg xlg:p-6 mt-3 lg:mt-0 p-3 text-white  hover:border-white duration-300 transition-all transform">
        ...
        <div className="  border border-white/20 rounded-xl shadow-lg xlg:p-6 p-3 text-white hover:border hover:border-white duration-300 transition-all transform">
          <button className="border mb-6 flex items-center gap-2  font-semibold py-2 px-5  rounded-md">
      Pay-Per-Download
            <UpgradeIcon />
          </button>
