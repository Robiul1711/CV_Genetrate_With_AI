  ...
  const content = (
    ...
    >
      ...
      <div className="flex items-center gap-1.5 font-bold ">
        <span className={`${sizeClasses.text} text-white font-bold font-sans`}>
          Clever
        </span>
        <span
          className={`${sizeClasses.text} text-transparent bg-clip-text bg-gradient-to-r from-[#81FB84] to-[#34D399] font-bold`}
        >
          CV
        </span>
