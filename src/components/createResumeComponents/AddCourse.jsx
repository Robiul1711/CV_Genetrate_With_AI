    ...
    <div className="bg-black text-white flex items-center justify-center p-6">
      <div className="max-w-6xl w-full">
        <div className="text-center flex flex-col items-center gap-4 mb-10">
          <Title level="title40">Add Another Courses and Training Details</Title>
          <Title level="title20">
...
<Title level="title32">Softvence agency </Title>
                ...
                <Title level="title24">
Mar 2024 - Jan 2025                </Title>
            </div>
             <CiEdit size={32} className="text-white cursor-pointer p-1 border border-white/30 rounded-full" />
          </div>
