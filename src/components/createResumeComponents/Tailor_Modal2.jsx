  ...
  return (
    <div>
      <Dialog>
        <DialogTrigger>
          {" "}
          <button  className="font-semibold  border-white bg-white text-black  px-8 py-2 text-lg rounded-md hover:bg-[#69CA6A] hover:text-white transition-colors duration-300">
