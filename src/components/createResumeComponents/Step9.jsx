...
const Step9 = () => {
  ...
  <button className='font-semibold flex items-center justify-center max-w-sm gap-2 border-white bg-white text-black text-sm  px-4 rounded-md hover:bg-[#69CA6A] hover:text-white transition-colors duration-300'>
